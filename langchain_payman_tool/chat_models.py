...
class ChatPaymanAI(BaseChatModel):
    ...
    """PaymanAI chat model integration.

    The default implementation echoes the first `parrot_buffer_length` characters of the input.

    # TODO: Replace with relevant packages, env vars.
    Setup:
        Install ``langchain-payman-tool`` and set environment variable ``PAYMANTOOL_API_KEY``.

        .. code-block:: bash

            pip install -U langchain-payman-tool
            export PAYMANTOOL_API_KEY="your-api-key"

    # TODO: Populate with relevant params.
    Key init args — completion params:
        model: str
            Name of PaymanAI model to use.
        temperature: float
    ...
    Key init args — client params:
        ...
        api_key: Optional[str]
            PaymanAI API key. If not passed in will be read from env var PAYMANTOOL_API_KEY.
    ...
    Tool calling:
        ...
        See ``ChatPaymanAI.bind_tools()`` method for more.
    ...
    Structured output:
        ...
        See ``ChatPaymanAI.with_structured_output()`` for more.
    ...
    # TODO: Implement if ChatPaymanAI supports async streaming. Otherwise delete.
    # async def _astream(
    #     self,
    #     messages: List[BaseMessage],
    #     stop: Optional[List[str]] = None,
    ...
    # TODO: Implement if ChatPaymanAI supports async generation. Otherwise delete.
