...
class PaymanAILoader(BaseLoader):
    ...
    """
    PaymanAI document loader integration
    ...
    Instantiate:
        .. code-block:: python
            ...
            from langchain_community.document_loaders import PaymanAILoader

            loader = PaymanAILoader(
                # required params = ...
                # other params = ...
            )
