...
class PaymanAIToolInput(BaseModel):
    """Input schema for PaymanAI tool.
...
class PaymanAITool(BaseTool):  # type: ignore[override]
    """PaymanAI tool.
    ...
    args_schema: Type[BaseModel] = PaymanAIToolInput
